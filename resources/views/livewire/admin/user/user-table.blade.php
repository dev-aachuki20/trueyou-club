                    ...
                    <td>
                        <div class="toggleSwitch-wrap">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="customSwitch1" wire:click.prevent="$emitUp('toggle',{{$user->id}})" {{ $user->is_active == 1 ? 'checked' : '' }}>
                    ...
                    <td>
                        <div class="update-webinar table-btns">
                            <ul class="d-flex">
                                @can('user_show')
                                <li>
                                    <a href="javascript:void()" wire:click.prevent="$emitUp('show', {{$user->id}})">
                                ...
                                @can('user_edit')
                                <li>
                                    <a href="javascript:void()" wire:click.prevent="$emitUp('edit', {{$user->id}})">
                                ...
                                @can('user_delete')
                                <li>
                                    <a href="javascript:void()" wire:click.prevent="$emitUp('delete', {{$user->id}})">
