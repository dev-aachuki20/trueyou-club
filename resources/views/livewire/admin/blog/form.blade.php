...
<form wire:submit.prevent="{{ $updateMode ? 'update' : 'store' }}" class="forms-sample">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label class="font-weight-bold justify-content-start">{{ __('cruds.blog.fields.title')}}<i class="fas fa-asterisk"></i></label>
                <input type="text" class="form-control" wire:model.defer="title" placeholder="{{ __('cruds.blog.fields.title')}}" autocomplete="off">
    ...
    <div class="row">
        <div class="col-md-12 mb-4">
            <div class="form-group mb-0" wire:ignore>
                <label class="font-weight-bold justify-content-start">{{ __('cruds.blog.fields.content')}}<i class="fas fa-asterisk"></i></label>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label class="font-weight-bold justify-content-start">{{ __('cruds.blog.fields.publish_date')}}<i class="fas fa-asterisk"></i></label>
                <input type="text" id="publish_date" class="form-control" wire:model.defer="publish_date" placeholder="{{ __('cruds.blog.fields.publish_date')}}" autocomplete="off">
