<div>
    <div class="relative">
        ...
        <div class="webinar_listing row">
            @if($allNews->count() > 0)
            @foreach($allNews as $serialNo => $news)
                ...
                <div class="webinar-item">
                    ...
                    <div class="update-webinar">
                        <ul class="d-flex">
                            @can('news_edit')
                            <li>
                                <a href="javascript:void()" wire:click.prevent="$emitUp('edit', {{$news->id}})">
                            ...
                            @can('news_delete')
                            <li>
                                <a href="javascript:void()" wire:click.prevent="$emitUp('delete', {{$news->id}})">
                            ...
                            @can('news_show')
                            <li>
                                <a href="javascript:void()" wire:click.prevent="$emitUp('show', {{$news->id}})">
        ...
        <th class="text-gray-500 text-xs">
            {{ __('cruds.news.fields.publish_date')}}
        </th>
            ...
            <tr>
                ...
                <td>
                    <label class="toggle-switch">
                        <input type="checkbox" class="toggleSwitch" wire:click.prevent="$emitUp('toggle',{{$news->id}})" {{ $news->status == 1 ? 'checked' : '' }}>
                ...
                <td>
                    ...
                    @can('news_show')
                    <button title="Show" type="button" wire:click.prevent="$emitUp('show', {{$news->id}})" class="btn btn-primary btn-rounded btn-icon">
                        <i class="ti-eye"></i>
                    </button>
                    @endcan

                    @can('news_edit')
                    <button title="Edit" type="button" wire:click.prevent="$emitUp('edit', {{$news->id}})" class="btn btn-info btn-rounded btn-icon">
                        <i class="ti-pencil-alt"></i>
                    </button>
                    @endcan

                    @can('news_delete')
                    <button title="Delete" type="button" wire:click.prevent="$emitUp('delete', {{$news->id}})" class="btn btn-danger btn-rounded btn-icon">
                        <i class="ti-trash"></i>
                    </button>
                    @endcan
