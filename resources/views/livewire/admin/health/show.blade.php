<div>
    ...
    <h4 class="card-title">@lang('global.view') @lang('cruds.health.title_singular')</h4>
        ...
        <div class="form-group row">
            <label class="col-sm-3 col-form-label font-weight-bold">@lang('cruds.health.fields.title')</label>
            <div class="col-sm-9 col-form-label">
        ...
        <div class="form-group row">
            <label class="col-sm-3 col-form-label font-weight-bold">@lang('cruds.health.fields.publish_date')</label>
            <div class="col-sm-9 col-form-label">
        ...
        <div class="form-group row">
            <label class="col-sm-3 col-form-label font-weight-bold">@lang('cruds.health.fields.content')</label>
            <div class="col-sm-9 col-form-label">
                {!! $detail->content !!}
            </div>
        </div>
