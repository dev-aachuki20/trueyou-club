        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('livewire.admin.health.form')

                    @elseif($viewMode)

                    @livewire('admin.health.show', ['health_id' => $health_id])

                    @else
                    <div wire:loading wire:target="create" class="loader"></div>
                    <div class="card-title top-box-set">
                        <h4 class="card-title-heading">@lang('cruds.health.title') @lang('global.list') </h4>
                    ...
                    <div class="search-table-data">
                       ...
                       {{-- @livewire('admin.health.health-table') --}}
                                            ...
                                            <div class="webinar-item">
                                                <div class="webinar-item-inner">
                                                    <div class="webinar-img">
                                                        <img class="img-fluid" src="{{ $health->health_image_url ? $health->health_image_url : asset(config('constants.default.no_image')) }}" alt="">
                                                    </div>
                                                    <div class="webinar-content">
                                                        ...
                                                        <span class="quotes-date seminar-date">
                                                            ...
                                                            {{ convertDateTimeFormat($health->publish_date,'fulldate') }}
                                                        </span>
                                                ...
                                                <div class="update-webinar">
                                                    <ul class="d-flex">
                                                        @can('health_show')
                                                        <li>
                                                            <a href="javascript:void()" wire:click.prevent="$emitUp('edit', {{$health->id}})" title="Edit">
                                                        ...
                                                        @can('health_delete')
                                                        <li>
                                                            <a href="javascript:void()" wire:click.prevent="$emitUp('delete', {{$health->id}})" title="Delete">
                                                        ...
                                                        @can('health_edit')
                                                        <li>
                                                            <a href="javascript:void()" wire:click.prevent="$emitUp('show', {{$health->id}})" title="View">
