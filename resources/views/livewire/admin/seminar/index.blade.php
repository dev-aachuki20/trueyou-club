                                    ...
                                    <li class="col-list">
                                        ...
                                        <div class="update-webinar">
                                            <ul class="d-flex">
                                                ...
                                                @if($endDateTime > $now)
                                                <li>
                                                    <a href="javascript:void()" wire:click.prevent="$emitUp('show', {{$seminar->id}})" title="View">
