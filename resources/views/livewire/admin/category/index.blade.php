                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ convertDateTimeFormat($category->created_at,'fulldate') }}</td>
    
                                                    <td>
                                                        <div class="toggleSwitch-wrap">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input" id="customSwitch{{$category->id}}" wire:click.prevent="$emitUp('toggle',{{$category->id}})" {{ $category->status == 1 ? 'checked' : '' }}>
                                                                <label class="custom-control-label" for="customSwitch{{$category->id}}">Break</label>
                                                            </div>
                                                        </div>                                                     
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="update-webinar table-btns">
                                                            <ul class="d-flex">
                                                                @can('category_show')
                                                                <li>
                                                                    <a href="javascript:void()" wire:click.prevent="$emit('show', {{$category->id}})" title="View">
                                                                ...
                                                                @can('category_edit')
                                                                <li>
                                                                    <a href="javascript:void()" wire:click.prevent="$emit('edit', {{$category->id}})" title="Edit">
                                                                ...
                                                                @can('category_delete')
                                                                <li>
                                                                    <a href="javascript:void()" wire:click.prevent="$emit('delete', {{$category->id}})" title="Delete">
