      ...
      <div class="card grid-margin">
         <div class="card-body">
            <div class="card-title top-box-set mb-5">
               <h4 class="card-title-heading blog-title mb-0">Overview</h4>
            </div>
            <div class="row">
               <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                  <div class="overview-item light-yellow">
                     <div class="inner-wrap">
                        ...
                        <div class="overview-content">
                           ...
                           <span class="count-listing"> {{ $totalRegisteredUser }}</span>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                  <div class="overview-item titan-white">
                     <div class="inner-wrap">
                        <div class="overview-icon-box">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="overview-content">
                           ...
                           <span class="count-listing"> {{ $totalActiveUser }}</span>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                  <div class="overview-item pearl">
                     <div class="inner-wrap">
                        <div class="overview-icon-box">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="overview-content">
                           ...
                           <span class="count-listing"> {{ $totalVIPUser }}</span>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                  <div class="overview-item lily-white">
                     <div class="inner-wrap">
                        <div class="overview-icon-box">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="overview-content">
                           <h3>
                              Total Seminar Tickets Purchased
                           </h3>
                           <span class="count-listing"> {{ $totalSeminarTikcketPurchased }}</span>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="qoute-listng">
                  <div class="contnet-box">
                     ...
                     <div class="qoute-item blur-qoute">
                        ...
                        <div role="progressbar" class="progress-bar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:{{(100 - (int)$submissionPercentage)}}%;"></div>
                     </div>
