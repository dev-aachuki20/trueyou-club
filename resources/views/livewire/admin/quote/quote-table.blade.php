<div>
    ...
    <div class="quotes-listing">
        <ul>
            ...
            <li>
                <div class="webinar-item">
                    ...
                    <span class="quotes-date">
                        ...
                        {{ convertDateTimeFormat($quote->created_at,'date') }}
                    </span>
                    <div class="update-webinar">
                        <ul class="d-flex">
                            @can('quote_edit')
                            <li>
                                <a href="javascript:void()" wire:click.prevent="$emitUp('edit', {{$quote->id}})">
            ...
            @else
            <div>
                <p></p class="text-center">{{ __('messages.no_record_found')}}</p>
            </div>
            @endif
