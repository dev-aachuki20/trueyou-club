                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-gray-500 text-xs">
                                                    ...
                                                    <span wire:click.prevent="sortBy('full_name')" class="float-right text-sm" style="cursor: pointer;">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="update-webinar table-btns">
                                                        <ul class="d-flex">
                                                            @can('contact_show')
                                                            <li>
                                                                <a href="javascript:void()" wire:click.prevent="$emit('show', {{$contact->id}})" title="View">
                                                            ...
                                                            @can('contact_delete')
                                                            <li>
                                                                <a href="javascript:void()" wire:click.prevent="$emit('delete', {{$contact->id}})" title="Delete">
                                                    ...
                                                    {{-- @can('contact_show')
                                                    <button title="Show" type="button" wire:click.prevent="$emit('show', {{$contact->id}})" class="btn btn-info view-btn btn-rounded btn-icon">
                                                    <i class="ti-eye"></i>
                                                    </button>
                                                    @endcan

                                                    @can('contact_delete')
                                                    <button title="Delete" type="button" wire:click.prevent="$emit('delete', {{$contact->id}})" class="btn btn-danger btn-rounded btn-icon">
                                                        <i class="ti-trash"></i>
                                                    </button>
                                                    @endcan --}}

                                                    {{-- @if($contact->is_draft == 1)
                                                    <button title="Reply" type="button" wire:click.prevent="$emit('reply', {{$contact->id}})" class="btn btn-success btn-rounded btn-icon">
